...
@class SharedResult, SharedKotlinThrowable, UIImage, SharedArticleData, SharedMediaMetadata, SharedMedia, SharedKotlinByteIterator, SharedKotlinByteArray, SharedKotlinArray<T>, SharedKotlinx_serialization_coreSerializersModule, SharedKotlinx_serialization_coreSerialKind, SharedKotlinNothing;
...
__attribute__((swift_name("ArticleAPI")))
@interface SharedArticleAPI : SharedBase
- (instancetype)init __attribute__((swift_name("init()"))) __attribute__((objc_designated_initializer));
+ (instancetype)new __attribute__((availability(swift, unavailable, message="use object initializers instead")));
- (void)getArticleListSuccess:(void (^)(NSArray<SharedResult *> *))success failure:(void (^)(SharedKotlinThrowable * _Nullable))failure __attribute__((swift_name("getArticleList(success:failure:)")));
- (void)getImageUrl:(NSString *)url success:(void (^)(UIImage * _Nullable))success failure:(void (^)(SharedKotlinThrowable * _Nullable))failure __attribute__((swift_name("getImage(url:success:failure:)")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ArticleData")))
@interface SharedArticleData : SharedBase
- (instancetype)initWithCopyright:(NSString * _Nullable)copyright num_results:(SharedInt * _Nullable)num_results results:(NSArray<SharedResult *> *)results status:(NSString * _Nullable)status __attribute__((swift_name("init(copyright:num_results:results:status:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SharedInt * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSArray<SharedResult *> *)component3 __attribute__((swift_name("component3()")));
- (NSString * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedArticleData *)doCopyCopyright:(NSString * _Nullable)copyright num_results:(SharedInt * _Nullable)num_results results:(NSArray<SharedResult *> *)results status:(NSString * _Nullable)status __attribute__((swift_name("doCopy(copyright:num_results:results:status:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable copyright __attribute__((swift_name("copyright")));
@property (readonly) SharedInt * _Nullable num_results __attribute__((swift_name("num_results")));
@property (readonly) NSArray<SharedResult *> *results __attribute__((swift_name("results")));
@property (readonly) NSString * _Nullable status __attribute__((swift_name("status")));
@end;

__attribute__((objc_subclassing_restricted))
__attribute__((swift_name("ArticleData.Companion")))
@interface SharedArticleDataCompanion : SharedBase
...
@interface SharedMedia : SharedBase
- (instancetype)initWithApproved_for_syndication:(SharedInt * _Nullable)approved_for_syndication caption:(NSString * _Nullable)caption copyright:(NSString * _Nullable)copyright MediaMetadata:(NSArray<SharedMediaMetadata *> * _Nullable)MediaMetadata subtype:(NSString * _Nullable)subtype type:(NSString * _Nullable)type __attribute__((swift_name("init(approved_for_syndication:caption:copyright:MediaMetadata:subtype:type:)"))) __attribute__((objc_designated_initializer));
- (SharedInt * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSString * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (NSArray<SharedMediaMetadata *> * _Nullable)component4 __attribute__((swift_name("component4()")));
- (NSString * _Nullable)component5 __attribute__((swift_name("component5()")));
- (NSString * _Nullable)component6 __attribute__((swift_name("component6()")));
- (SharedMedia *)doCopyApproved_for_syndication:(SharedInt * _Nullable)approved_for_syndication caption:(NSString * _Nullable)caption copyright:(NSString * _Nullable)copyright MediaMetadata:(NSArray<SharedMediaMetadata *> * _Nullable)MediaMetadata subtype:(NSString * _Nullable)subtype type:(NSString * _Nullable)type __attribute__((swift_name("doCopy(approved_for_syndication:caption:copyright:MediaMetadata:subtype:type:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSArray<SharedMediaMetadata *> * _Nullable MediaMetadata __attribute__((swift_name("MediaMetadata")));
@property (readonly) SharedInt * _Nullable approved_for_syndication __attribute__((swift_name("approved_for_syndication")));
...
@interface SharedMediaCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
@interface SharedMediaMetadata : SharedBase
- (instancetype)initWithFormat:(NSString * _Nullable)format height:(SharedInt * _Nullable)height url:(NSString * _Nullable)url width:(SharedInt * _Nullable)width __attribute__((swift_name("init(format:height:url:width:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (SharedInt * _Nullable)component2 __attribute__((swift_name("component2()")));
- (NSString * _Nullable)component3 __attribute__((swift_name("component3()")));
- (SharedInt * _Nullable)component4 __attribute__((swift_name("component4()")));
- (SharedMediaMetadata *)doCopyFormat:(NSString * _Nullable)format height:(SharedInt * _Nullable)height url:(NSString * _Nullable)url width:(SharedInt * _Nullable)width __attribute__((swift_name("doCopy(format:height:url:width:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
...
@interface SharedMediaMetadataCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
...
- (instancetype)initWithAbstract:(NSString * _Nullable)abstract adx_keywords:(NSString * _Nullable)adx_keywords asset_id:(SharedLong * _Nullable)asset_id byline:(NSString * _Nullable)byline column:(NSString * _Nullable)column des_facet:(NSArray<NSString *> *)des_facet eta_id:(SharedInt * _Nullable)eta_id geo_facet:(NSArray<NSString *> *)geo_facet id:(SharedLong * _Nullable)id media:(NSArray<SharedMedia *> * _Nullable)media nytdsection:(NSString * _Nullable)nytdsection org_facet:(NSArray<NSString *> *)org_facet per_facet:(NSArray<NSString *> *)per_facet published_date:(NSString * _Nullable)published_date section:(NSString * _Nullable)section source:(NSString * _Nullable)source subsection:(NSString * _Nullable)subsection title:(NSString * _Nullable)title type:(NSString * _Nullable)type updated:(NSString * _Nullable)updated uri:(NSString * _Nullable)uri url:(NSString * _Nullable)url __attribute__((swift_name("init(abstract:adx_keywords:asset_id:byline:column:des_facet:eta_id:geo_facet:id:media:nytdsection:org_facet:per_facet:published_date:section:source:subsection:title:type:updated:uri:url:)"))) __attribute__((objc_designated_initializer));
- (NSString * _Nullable)component1 __attribute__((swift_name("component1()")));
- (NSArray<SharedMedia *> * _Nullable)component10 __attribute__((swift_name("component10()")));
...
- (SharedLong * _Nullable)component9 __attribute__((swift_name("component9()")));
- (SharedResult *)doCopyAbstract:(NSString * _Nullable)abstract adx_keywords:(NSString * _Nullable)adx_keywords asset_id:(SharedLong * _Nullable)asset_id byline:(NSString * _Nullable)byline column:(NSString * _Nullable)column des_facet:(NSArray<NSString *> *)des_facet eta_id:(SharedInt * _Nullable)eta_id geo_facet:(NSArray<NSString *> *)geo_facet id:(SharedLong * _Nullable)id media:(NSArray<SharedMedia *> * _Nullable)media nytdsection:(NSString * _Nullable)nytdsection org_facet:(NSArray<NSString *> *)org_facet per_facet:(NSArray<NSString *> *)per_facet published_date:(NSString * _Nullable)published_date section:(NSString * _Nullable)section source:(NSString * _Nullable)source subsection:(NSString * _Nullable)subsection title:(NSString * _Nullable)title type:(NSString * _Nullable)type updated:(NSString * _Nullable)updated uri:(NSString * _Nullable)uri url:(NSString * _Nullable)url __attribute__((swift_name("doCopy(abstract:adx_keywords:asset_id:byline:column:des_facet:eta_id:geo_facet:id:media:nytdsection:org_facet:per_facet:published_date:section:source:subsection:title:type:updated:uri:url:)")));
- (BOOL)isEqual:(id _Nullable)other __attribute__((swift_name("isEqual(_:)")));
- (NSUInteger)hash __attribute__((swift_name("hash()")));
- (NSString *)description __attribute__((swift_name("description()")));
@property (readonly) NSString * _Nullable abstract __attribute__((swift_name("abstract")));
@property (readonly) NSString * _Nullable adx_keywords __attribute__((swift_name("adx_keywords")));
@property (readonly) SharedLong * _Nullable asset_id __attribute__((swift_name("asset_id")));
@property (readonly) NSString * _Nullable byline __attribute__((swift_name("byline")));
@property (readonly) NSString * _Nullable column __attribute__((swift_name("column")));
@property (readonly) NSArray<NSString *> *des_facet __attribute__((swift_name("des_facet")));
@property (readonly) SharedInt * _Nullable eta_id __attribute__((swift_name("eta_id")));
@property (readonly) NSArray<NSString *> *geo_facet __attribute__((swift_name("geo_facet")));
@property (readonly) SharedLong * _Nullable id __attribute__((swift_name("id")));
@property (readonly) NSArray<SharedMedia *> * _Nullable media __attribute__((swift_name("media")));
@property (readonly) NSString * _Nullable nytdsection __attribute__((swift_name("nytdsection")));
@property (readonly) NSArray<NSString *> *org_facet __attribute__((swift_name("org_facet")));
@property (readonly) NSArray<NSString *> *per_facet __attribute__((swift_name("per_facet")));
@property (readonly) NSString * _Nullable published_date __attribute__((swift_name("published_date")));
...
@property (readonly) NSString * _Nullable subsection __attribute__((swift_name("subsection")));
...
@interface SharedResultCompanion : SharedBase
+ (instancetype)alloc __attribute__((unavailable));
+ (instancetype)allocWithZone:(struct _NSZone *)zone __attribute__((unavailable));
+ (instancetype)companion __attribute__((swift_name("init()")));
- (id<SharedKotlinx_serialization_coreKSerializer>)serializer __attribute__((swift_name("serializer()")));
